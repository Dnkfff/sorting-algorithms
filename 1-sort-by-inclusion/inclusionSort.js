...
for (let value of A){
        if (value & 1){
            oddA.push(value);
        } else evenA.push(value);
}

//functions that provide sorting of our arrays 
const oddSorted = oddA.sort((a, b) => b - a);
const evenSorted = evenA.sort((a, b) => {if (a > b) return 1;if (a == b) return 0; if (a < b) return -1;});

//concating oddSorted and evenSorted
const done = evenSorted.concat(oddSorted);
